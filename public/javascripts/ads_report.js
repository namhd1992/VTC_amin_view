...
var item_name = "Ads report";
var item_names = "Ads reports";
var deleted_id = null;
		...
		"columns": [
			...
			},
			{
				...
				render: function (data, type, full, meta) {
					var return_str = "";
					if (checkFunction("gameManager")) {
						return_str += "<a href='banner_report?id=" + full.campaignId + "' item_id='" + full.campaignId + "' item_obj='" + JSON.stringify(full) + "'><i class='icon-graph'></i> Detail </a>";
					}
					return return_str;
				}
			}
