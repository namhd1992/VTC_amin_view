...
var load_page = function () {
	...
	page_datatable = $('#page_datatable').DataTable({
		"ajax": {
			"url": base_request_url + "/admin/splayTag",
			"type": "GET",
			"data": function (d) {
		...
		"columns": [
			...
			{ title: "Color", data: "backgroundColor" },
			{
				title: "Create On",
				data: null,
		...
		"aoColumnDefs": [
			...
			{ responsivePriority: 1, "sWidth": "10%", 'aTargets': [3] },
			{ responsivePriority: 2, "sWidth": "30%", 'aTargets': [4] },
		...
		"fnDrawCallback": function (oSettings) {
			...
			$(".btn_edit_item").click(function () {
				...
				$('#modal_add_edit .txt_add_edit_item_type').val(obj_temp.typeName);
				$('#modal_add_edit .txt_add_edit_item_color').val(obj_temp.backgroundColor);
	...
	$('.btn_confirm_yes').click(function () {
		$.ajax({
			url: base_request_url + "/admin/splayTag?id=" + deleted_id,
			type: "DELETE",
			contentType: "application/json",
			dataType: "json",
			beforeSend: function (xhr) {
	...
	$('.btn_modal_save_new').click(function () {
		...
		_send_info.data = {
			...
			"typeName": $("#single_select_type").val(),
			"backgroundColor": $(".txt_add_edit_item_color").val(),
		};
		$(".loading_icon").show();
		$.ajax({
			url: base_request_url + "/admin/splayTag",
