...
var item_name = "Banner landing";
var item_names = "Banner landings";
var deleted_id = null;
...
var load_page = function () {
	...
	page_datatable = $('#page_datatable').DataTable({
		...
		"columns": [
			{ title: "ID", data: "id" },
			{ title: "Name", data: "landingPageName" },
			{
				title: "Status",
				data: null,
		...
		"fnDrawCallback": function (oSettings) {
			...
			$(".btn_edit_item").click(function () {
				...
				$('#modal_add_edit .modal-title').html("Edit " + item_name + " " + obj_temp.landingPageName);
				$('#modal_add_edit .txt_add_edit_item_name').val(obj_temp.landingPageName);
				$('#modal_add_edit .txt_add_edit_item_url').val(obj_temp.defaultUrl);
	...
	$('.btn_confirm_yes').click(function () {
		$.ajax({
			url: base_request_url + "/admin/splayLandingPage?id=" + deleted_id,
			type: "DELETE",
			contentType: "application/json",
			dataType: "json",
			beforeSend: function (xhr) {
	...
	$('.btn_modal_save_new').click(function () {
		...
		_send_info.data = {
			"landingPageName": $(".txt_add_edit_item_name").val(),
			"defaultUrl": $(".txt_add_edit_item_url").val(),
