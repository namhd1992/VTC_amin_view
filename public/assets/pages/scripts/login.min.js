var Login = function() { var e = function() { $(".login-form").validate({ errorElement: "span", errorClass: "help-block", focusInvalid: !1, rules: { username: { required: !0 }, password: { required: !0 }, remember: { required: !1 } }, messages: { username: { required: "Username is required." }, password: { required: "Password is required." } }, invalidHandler: function(e, r) { $(".alert-danger", $(".login-form")).show() }, highlight: function(e) { $(e).closest(".form-group").addClass("has-error") }, success: function(e) { e.closest(".form-group").removeClass("has-error"), e.remove() }, errorPlacement: function(e, r) { e.insertAfter(r.closest(".input-icon")) }, submitHandler: function(e) { e.submit() } }), $(".login-form input").keypress(function(e) { 13 == e.which && r() }), $(".action_login").click(function() { r() }) },
        r = function() { $(".login-form").validate().form() && $.ajax({ url: $(".login-form").attr("action"), type: "POST", data: $(".login-form").serialize(), contentType: "application/x-www-form-urlencoded", dataType: "html", beforeSend: function(e) { e.setRequestHeader("Authorization", i("vtcmobile", "vtc@2017")) }, success: function(e) { localStorage.setItem("user_data", e), console.log("login success"), document.location.replace("index.html") } }) },
        i = function(e, r) { var i = e + ":" + r,
                o = btoa(i); return "Basic " + o },
